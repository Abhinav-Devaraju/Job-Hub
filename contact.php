...
<head>
	...
	<title>Job Hub - Contact Us</title>
    ...
    <meta property="og:image:alt" content="Job Hub" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> x <br/> y <br/>z</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:xyz@gmail.com">xyz@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+91123">+91123</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job Hub</h5>
											<p>Job Hub is a job portal, online job management system developed by Abhinav D for his project</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Job Hub Contact</h5>
								
								<p>Address : </p>
								<p>Email : <a href="mailto:xyz@gmail.com">xyz@gmail.com</a></p>
								<p>Phone : <a href="tel:+91123">+91123</a></p>
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Abhinav D</a></li>
								</ul>
